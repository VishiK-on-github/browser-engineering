...
ENTRIES = [
    ("No names. We are nameless!", "vishu"),
    ("HACK THE PLANET!!!", "evilvishu")
]
SESSIONS = {}
LOGINS = {
    "vishu": "1234",
...
def show_comments(session):
    ...
    # we add html escape to prevent adversarial comments 
    # which might try to add there own cookie stealing js scripts
